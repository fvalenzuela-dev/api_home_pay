        ...
        "/accounts": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Campo de orden (created_at, name, billing_day, company_name)",
                        "name": "sort",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos de la cuenta (company_id requerido)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/accounts/{accountID}/billings": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Account ID (nested routes)",
                        "name": "accountID",
                        "in": "path"
                    },
                    {
        ...
        "/billings": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filtrar por account ID",
                        "name": "account_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Periodo inicio YYYYMM (inclusive)",
                        "name": "from_period",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Periodo fin YYYYMM (inclusive)",
                        "name": "to_period",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Filtrar por estado: true=pagadas, false=impagas",
                        "name": "is_paid",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "models.Category": {
            ...
            "properties": {
                ...
                "color_apk": {
                    "description": "ColorApk is the hex color code or identifier used for the mobile (APK) platform.",
                    "type": "string"
                },
                "color_web": {
                    "description": "ColorWeb is the hex color code or identifier used for the web platform.",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "icon_apk": {
                    "description": "IconApk is the identifier or resource name for the icon displayed on mobile (APK) platforms.",
                    "type": "string"
                },
                "icon_web": {
                    "description": "IconWeb is the identifier or URL for the icon displayed on web platforms.",
                    "type": "string"
                },
                "id": {
                    "type": "integer"
        ...
        "models.CreateBillingRequest": {
            ...
            "properties": {
                "account_id": {
                    "description": "requerido en top-level /billings, ignorado en nested",
                    "type": "string"
                },
                "amount_billed": {
                    "type": "number"
