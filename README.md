...
### Validation & Quality
- **Central Validation**: Triggered on pushes to feature branches (excluding `main` and `develop`). It validates the `VERSION` file, ensures the application builds, and passes all automated tests.
