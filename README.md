...
### Validation & Quality
- **Central Validation**: Triggered on pull requests targeting the `develop` and `main` branches. It validates the `VERSION` file, ensures the application builds, and passes all automated tests.
